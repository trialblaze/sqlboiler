...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/trialblaze/sqlboiler", "github.com/volatiletech/null"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/trialblaze/sqlboiler"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null" && c.ThirdParty[1] != "github.com/trialblaze/sqlboiler" {
		t.Errorf("Wanted: github.com/trialblaze/sqlboiler, github.com/volatiletech/null got: %#v", c.ThirdParty)
	}
}
